...
if __name__ == '__main__':
    PROWLARR_USER = os.environ.get('PROWLARR_USER') or "admin"
    ...
    PASSWORD = verify_hashed_password(PROWLARR_DB, PROWLARR_USER, PROWLARR_PASSWORD)
    if PASSWORD is None:
        sys.exit(1)
    elif PASSWORD == "empty":
        logging.info("User %s doesnt exist, create ..." % PROWLARR_USER)
        ...
        logging.info("User %s already exist with this password, nothing to do ..." % PROWLARR_USER)
